...
export const FAMILY: Person[] = [
  ...
  },
  {
    name: "William",
    age: 25,
    profile: "Snart klar civilingenjör i Lund. Reser med flickvännen Anna.",
    tags: [],
  },
  {
    name: "Anna",
    age: 25,
    profile: "Williams flickvän.",
    tags: [],
  },
  {
    name: "Leja",
    age: 24,
    profile: "Läser juridik i Örebro, första året.",
    tags: [],
  },
  {
    name: "Leo",
    age: 17,
    profile:
      "Fyller 18 den 17 juli under resan. Naturvetenskap på Sjölins i Stockholm. Gillar utegym och kalistenik. Alkohol i Frankrike är 18+ — Leo är 17 fram till 17 juli.",
